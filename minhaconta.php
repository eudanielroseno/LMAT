            ...
            <header class="mb-5">
                ...
                <div class="card">
                  ...
                  if(isset($_POST['btnUp'])){
                      ...
                      $editar = "UPDATE user SET usuario_registro=:nome,senha_registro=:senha,foto_registro=:foto WHERE 
                      id_registro=:id";
                      $cadastro = "INSERT INTO user (usuario_registro, senha_registro, foto_registro) VALUES (:nome, :email, :senha, :foto)";
                      try{
